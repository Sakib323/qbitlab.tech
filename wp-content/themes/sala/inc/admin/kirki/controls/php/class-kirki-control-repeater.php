					...
					<# _.each( data, function( field, i ) { #>
						...
						<div class="repeater-field repeater-field-{{{ field.type }}} repeater-field-{{ field.id }}">
							...
							<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
								...
								<figure class="kirki-image-attachment" data-placeholder="<?php esc_html_e( 'No Image Selected', 'kirki' ); ?>" >
									<# if ( field.default ) { #>
								...
								<div class="actions">
									...
									<button type="button" class="button upload-button" data-label=" <?php esc_html_e( 'Add Image', 'kirki' ); ?>" data-alt-label="<?php echo esc_html_e( 'Change Image', 'kirki' ); ?>" >
										<# if ( field.default ) { #>
							...
							<# } else if ( field.type === 'upload' ) { #>
								...
								<figure class="kirki-file-attachment" data-placeholder="<?php esc_html_e( 'No File Selected', 'kirki' ); ?>" >
									<# if ( field.default ) { #>
								...
								<div class="actions">
									<button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"><?php esc_html_e( 'Remove', 'kirki' ); ?></button>
									<button type="button" class="button upload-button" data-label="<?php esc_html_e( 'Add File', 'kirki' ); ?>" data-alt-label="<?php esc_html_e( 'Change File', 'kirki' ); ?>">
										<# if ( field.default ) { #>
