...
class Widget_Flip_Box extends Base {
	...
	public function get_name() {
		return 'sala-flip-box';
	}

	public function get_title() {
		return esc_html__( 'Advanced Flip Box', 'sala' );
	}
	...
	private function add_front_side_content_section() {
		$this->start_controls_section( 'content_front_side_section', [
			'label' => esc_html__( 'Front', 'sala' ),
		] );

		$this->start_controls_tabs( 'side_a_content_tabs' );

		$this->start_controls_tab( 'side_a_content_tab', [ 'label' => esc_html__( 'Content', 'sala' ) ] );

		$this->add_control( 'graphic_element_a', [
			'label'       => esc_html__( 'Graphic Element', 'sala' ),
			'type'        => Controls_Manager::CHOOSE,
			'label_block' => false,
			'options'     => [
				'none'  => [
					'title' => esc_html__( 'None', 'sala' ),
					'icon'  => 'eicon-ban',
				],
				'image' => [
					'title' => esc_html__( 'Image', 'sala' ),
					'icon'  => 'fa fa-picture-o',
				],
				'icon'  => [
					'title' => esc_html__( 'Icon', 'sala' ),
					'icon'  => 'eicon-star',
				],
			],
			'default'     => 'icon',
		...
		$this->add_control( 'title_text_a', [
			'label'       => esc_html__( 'Title & Description', 'sala' ),
		...
		$this->add_control( 'description_text_a', [
			...
			'default'     => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'sala' ),
		...
		$this->start_controls_tab( 'side_a_background_tab', [ 'label' => esc_html__( 'Background', 'sala' ) ] );
	...
	private function add_back_side_content_section() {
		$this->start_controls_section( 'content_back_side_section', [
			'label' => esc_html__( 'Back', 'sala' ),
		] );

		$this->start_controls_tabs( 'side_b_content_tabs' );

		$this->start_controls_tab( 'side_b_content_tab', [ 'label' => esc_html__( 'Content', 'sala' ) ] );
		...
		$this->start_controls_tab( 'side_b_background_tab', [ 'label' => esc_html__( 'Background', 'sala' ) ] );
	...
	private function add_box_settings_section() {
		$this->start_controls_section( 'section_box_settings', [
			'label' => esc_html__( 'Settings', 'sala' ),
		] );
		...
		$this->add_responsive_control( 'min_height', [
			...
			'size_units' => [ 'px' ],
			'selectors'  => [
				'{{WRAPPER}} .sala-flip-box' => 'min-height: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_control( 'flip_effect', [
			'label'        => esc_html__( 'Flip Effect', 'sala' ),
			'type'         => Controls_Manager::SELECT,
			'default'      => 'flip',
			'options'      => [
				'flip'     => 'Flip',
			...
			'prefix_class' => 'sala-flip-box--effect-',
		] );

		$this->add_control( 'flip_direction', [
			'label'        => esc_html__( 'Flip Direction', 'sala' ),
			'type'         => Controls_Manager::SELECT,
			'default'      => 'up',
			'options'      => [
				'left'  => esc_html__( 'Left', 'sala' ),
				'right' => esc_html__( 'Right', 'sala' ),
				'up'    => esc_html__( 'Up', 'sala' ),
				'down'  => esc_html__( 'Down', 'sala' ),
			],
			'condition'    => [
				'flip_effect!' => [
					'fade',
			...
			'prefix_class' => 'sala-flip-box--direction-',
		] );

		$this->add_control( 'flip_3d', [
			'label'        => esc_html__( '3D Depth', 'sala' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => esc_html__( 'On', 'sala' ),
			'label_off'    => esc_html__( 'Off', 'sala' ),
			'return_value' => 'sala-flip-box--3d',
			'default'      => '',
			'prefix_class' => '',
			'condition'    => [
				'flip_effect' => 'flip',
	...
	private function add_front_side_box_style_section() {
		$this->start_controls_section( 'box_style_front_side_section', [
			'label' => esc_html__( 'Front - Box', 'sala' ),
		...
		$this->add_control( 'vertical_position_a', [
			'label'                => esc_html__( 'Vertical Position', 'sala' ),
			'type'                 => Controls_Manager::CHOOSE,
			'label_block'          => false,
			'options'              => [
				'top'    => [
	...
	private function add_front_side_image_style_section() {
		$this->start_controls_section( 'image_style_front_side_section', [
			'label'     => esc_html__( 'Front - Image', 'sala' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'graphic_element_a' => 'image',
			],
	...
	private function add_front_side_icon_style_section() {
		$this->start_controls_section( 'icon_style_front_side_section', [
			'label'     => esc_html__( 'Front - Icon', 'sala' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'graphic_element_a' => 'icon',
			],
		...
		$this->add_control( 'icon_spacing_a', [
			...
			'selectors' => [
				'{{WRAPPER}} .front-side .sala-icon-wrap' => 'margin-bottom: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_responsive_control( 'icon_size_a', [
			...
			'selectors' => [
				'{{WRAPPER}} .front-side .sala-icon-view, {{WRAPPER}} .front-side .sala-icon' => 'font-size: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_control( 'icon_rotate_a', [
			...
			'selectors' => [
				'{{WRAPPER}} .front-side .sala-icon' => 'transform: rotate({{SIZE}}{{UNIT}});',
			],
		] );
	...
	private function add_front_side_heading_style_section() {
		$this->start_controls_section( 'heading_style_front_side_section', [
			'label'     => esc_html__( 'Front - Heading', 'sala' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'title_text_a!' => '',
			],
	...
	private function add_front_side_description_style_section() {
		$this->start_controls_section( 'description_style_front_side_section', [
			'label'     => esc_html__( 'Front - Description', 'sala' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'description_text_a!' => '',
			],
	...
	private function add_back_side_box_style_section() {
		$this->start_controls_section( 'box_style_back_side_section', [
			'label' => esc_html__( 'Back - Box', 'sala' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		] );
	...
	private function add_back_side_image_style_section() {
		$this->start_controls_section( 'image_style_back_side_section', [
			'label'     => esc_html__( 'Back - Image', 'sala' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'graphic_element_b' => 'image',
			],
	...
	private function add_back_side_icon_style_section() {
		$this->start_controls_section( 'icon_style_back_side_section', [
			'label'     => esc_html__( 'Back - Icon', 'sala' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'graphic_element_b' => 'icon',
			],
		...
		$this->add_control( 'icon_spacing_b', [
			...
			'selectors' => [
				'{{WRAPPER}} .back-side .sala-icon-wrap' => 'margin-bottom: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_responsive_control( 'icon_size_b', [
			...
			'selectors' => [
				'{{WRAPPER}} .back-side .sala-icon-view, {{WRAPPER}} .back-side .sala-icon' => 'font-size: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_control( 'icon_rotate_b', [
			...
			'selectors' => [
				'{{WRAPPER}} .back-side .sala-icon' => 'transform: rotate({{SIZE}}{{UNIT}});',
			],
		] );
	...
	private function add_back_side_heading_style_section() {
		$this->start_controls_section( 'heading_style_back_side_section', [
			'label'     => esc_html__( 'Back - Heading', 'sala' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'title_text_b!' => '',
			],
	...
	private function add_back_side_description_style_section() {
		$this->start_controls_section( 'description_style_back_side_section', [
			'label'     => esc_html__( 'Back - Description', 'sala' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'description_text_b!' => '',
			],
	...
	private function print_heading( array $settings, $side = 'a' ) {
		...
		<div class="heading-wrap">
			<h3 class="heading">
				<?php echo wp_kses( $settings["title_text_{$side}"], 'sala-default' ); ?>
			</h3>
		</div>
		<?php
	}
	...
	private function print_description( array $settings, $side = 'a' ) {
		...
		<div class="description-wrap">
			<div class="description">
				<?php echo wp_kses( $settings["description_text_{$side}"], 'sala-default' ); ?>
			</div>
		</div>
		<?php
	}
				...
				<div class="layer-inner">
					<div class="layer-content">
						...
						<#  } else if ( 'icon' === settings.graphic_element_a ) { #>
							<#
							view.addRenderAttribute( 'iconA', 'class', 'sala-icon icon' );

							if ( 'svg' === settings.icon_a.library ) {
								view.addRenderAttribute( 'iconA', 'class', 'sala-svg-icon' );
							}

							if ( 'gradient' === settings.icon_a_color_type ) {
								view.addRenderAttribute( 'iconA', 'class', 'sala-gradient-icon' );
							} else {
								view.addRenderAttribute( 'iconA', 'class', 'sala-solid-icon' );
							}
				...
				<div class="layer-inner">
					<div class="layer-content">
						...
						<#  } else if ( 'icon' === settings.graphic_element_b ) { #>
							<#
							view.addRenderAttribute( 'iconB', 'class', 'sala-icon icon' );

							if ( 'svg' === settings.icon_b.library ) {
								view.addRenderAttribute( 'iconB', 'class', 'sala-svg-icon' );
							}

							if ( 'gradient' === settings.icon_b_color_type ) {
								view.addRenderAttribute( 'iconB', 'class', 'sala-gradient-icon' );
							} else {
								view.addRenderAttribute( 'iconB', 'class', 'sala-solid-icon' );
							}
