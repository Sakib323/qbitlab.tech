...
class Widget_Image_Layers extends Base {
	...
	public function get_name() {
		return 'sala-image-layers';
	}

	public function get_title() {
		return esc_html__( 'Image Layers', 'sala' );
	}
	...
	private function add_layers_section() {
		...
		$repeater->add_control( 'static', [
			'label' => esc_html__( 'Static Layer', 'sala' ),
		...
		$repeater->add_control( 'loop', [
			...
			'options' => [
				...
				'rotate'          => esc_html__( 'Rotate', 'sala' ),
				'move-horizontal' => esc_html__( 'Move - Horizontal', 'sala' ),
				'move-vertical'   => esc_html__( 'Move - Vertical', 'sala' ),
			],
			'default' => '',
		] );
