<?php
  ...
  * Slug: gutenify-virtual-reality/cover-with-shop-title
...
<h1 class="wp-block-heading has-text-align-center has-background-color has-text-color"><?php echo esc_html__( 'Shop', 'gutenify-virtual-reality' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->